// Source: https://github.com/nodejs/node/blob//v22.7.0/test/parallel/test-url-relative.js
...
for (const relativeTest of relativeTests) {
...
for (const relativeTest of relativeTests2) {
