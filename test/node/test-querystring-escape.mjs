// Source: https://github.com/nodejs/node/blob//v22.7.0/test/parallel/test-querystring-escape.js
...
assert.strictEqual(
  qs.escape(`${String.fromCharCode(0xd8_00 + 1)}test`),
  "%F0%90%91%B4est",
);

assert.throws(() => qs.escape(String.fromCharCode(0xd8_00 + 1)), {
